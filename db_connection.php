...
try {
    $conn = new PDO("sqlsrv:server = tcp:testwebappsql.database.windows.net,1433; Database = twdatabase", "sql", "Aa12345678");
...
$serverName = "tcp:testwebappsql.database.windows.net,1433";
